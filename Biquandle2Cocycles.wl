...
Biquandle2CocycleInvariantColoringValue[L_PD, coloring_List, \[Phi]_List] := Times @@ (Biquandle2CocycleInvariantCrossingValue[#,coloring,\[Phi]]& /@ L);

Biquandle2CocycleInvariantValue[L_PD, Biquandle2Cocycle[B_Biquandle, \[Phi]_List]] := Biquandle2CocycleInvariantColoringValue[L, #, \[Phi]]& /@ AllBiquandleColorings[L, B];
